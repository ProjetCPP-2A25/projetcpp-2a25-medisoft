...
QSqlQueryModel* Employee::afficher()  {
    ...
    // Exécutez la requête
    model->setQuery("SELECT IDE, NOM, PRENOM, MAIL, DATE_EMB, SALAIRE, TELEPHONE,ROLE FROM EMPLOYES");
...
QSqlQueryModel* Employee::tri(QString column)
 {
 QSqlQueryModel* model = new QSqlQueryModel();
 model->setQuery("SELECT IDE, NOM, PRENOM, MAIL, DATE_EMB, SALAIRE, TELEPHONE,ROLE FROM EMPLOYES ORDER BY " + column + " ASC");
...
QSqlQueryModel* Employee::tri1(QString column)
 {
 QSqlQueryModel* model = new QSqlQueryModel();
 model->setQuery("SELECT IDE, NOM, PRENOM, MAIL, DATE_EMB, SALAIRE, TELEPHONE,ROLE FROM EMPLOYES ORDER BY " + column + " DESC");
 model->setHeaderData(0,Qt::Horizontal,QObject::tr("ID"));
 model->setHeaderData(1,Qt::Horizontal,QObject::tr("NOM"));
 model->setHeaderData(2,Qt::Horizontal,QObject::tr("PRENOM"));
 model->setHeaderData(3,Qt::Horizontal,QObject::tr("MAIL"));
...
QSqlQueryModel* Employee::chercher(QString column,QString text)
 {
 QSqlQueryModel* model = new QSqlQueryModel();
 model->setQuery("SELECT IDE, NOM, PRENOM, MAIL, DATE_EMB, SALAIRE, TELEPHONE,ROLE FROM EMPLOYES WHERE  " + column + " LIKE '%" + text + "%' ");
 model->setHeaderData(0,Qt::Horizontal,QObject::tr("ID"));
 model->setHeaderData(1,Qt::Horizontal,QObject::tr("NOM"));
 model->setHeaderData(2,Qt::Horizontal,QObject::tr("PRENOM"));
 model->setHeaderData(3,Qt::Horizontal,QObject::tr("MAIL"));
