...
int mailerr::sendEmail(QString dist, QString obj, QString bdy) {
...
QString mailerr::wrapText(const QString &input) {
    QString result;
    QTextStream stream(&result); // UTF-8 utilisé par défaut dans Qt 6
    stream << input;
    return result;
}
